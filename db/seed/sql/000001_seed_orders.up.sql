...
-- ORDERS
-- =============================================================================
-- Alice: 2 orders (both completed)
-- David: 2 orders (1 pending, 1 confirmed)
...
INSERT INTO order_items (id, order_id, product_id, product_name, quantity, price, subtotal, created_at) VALUES
    ...
    -- Order 2 (Alice, completed): Webcam HD x1, Gaming Headset x1
    ...
    -- Order 4 (David, confirmed): Monitor 24" x1
