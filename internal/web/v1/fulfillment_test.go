...
func TestStartFulfillment_StartsWorkflow(t *testing.T) {
	starter := &stubStarter{}
	h := NewOrderHandler(newOutboxService(&stubOutbox{}), nil, nil, starter, "order-fulfillment", nil, "", nil)
...
func TestStartFulfillment_NilTemporalIsNoop(t *testing.T) {
	h := NewOrderHandler(newOutboxService(&stubOutbox{}), nil, nil, nil, "order-fulfillment", nil, "", nil)
...
func TestCreateOrder_RejectsBadPaymentMethod(t *testing.T) {
	h := NewOrderHandler(newOutboxService(&stubOutbox{}), nil, nil, nil, "", nil, "", nil)
...
func TestStartFulfillment_ClosesTheOutboxRowOnSuccess(t *testing.T) {
	starter := &stubStarter{}
	outbox := &stubOutbox{}
	h := NewOrderHandler(newOutboxService(outbox), nil, nil, starter, "order-fulfillment", nil, "", nil)
